...
(function(){
  ...
  function criarEscrever(){
    var div=$('<div id="novo-post"> <textarea name="texto" placeholder="Escreva aqui..."></textarea><label for="enviar_imvi"><i class="fa-sharp fa-solid fa-images"></i></label><input multiple id="enviar_imvi" type="file" accept="image/*" capture="user"><button type="button" name="enviar" >Enviar</button> <button type="button" name="cancelar_envio" >Cancelar</button></div>');
    $("body").append(div);
    if (escrito) {
